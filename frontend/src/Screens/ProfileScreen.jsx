  ...
  const submitHandler = async (e) => {
    ...
    if (password !== confirmPassword) {
      ...
      try {
        ...
        toast.success('Profile updated succesfFully');
      } catch (err) {
    ...
    <Row>
      <Col md={3}>
        ...
        <Form onSubmit={submitHandler}>
          <Form.Group controleId='name' className='my-2'>
          ...
          <Form.Group controleId='email' className='my-2'>
      ...
      <Col md={9}>
        ...
        {isLoading ? (
          ...
          <Table spired hover responsive className='table-sm'>
            <thead>
              <tr>
                <th>Id</th>
                <th>DATE</th>
